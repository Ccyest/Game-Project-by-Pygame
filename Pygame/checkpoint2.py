...
instructions = [gamebox.from_text(650,100,'Press J for melee attack',30,'white'),
                ...
                gamebox.from_text(100,530,'and Jake Berry',30,'white')]
...
def tick(keys):
    ...
    global enemies, reborn_counter, enemy_walk_frame, enemy_attack_frame, enemy_hurt_frame, enemy_idle_frame, enemy_death_frame, enemy_time_counter, enemy_DPS,reborn_difficulty
    global player, player_attributes, player_move, player_HP,player_HP_bar, facing_right, DPS
